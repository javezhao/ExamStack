							...
							<div class="flex-caption">
								...
								<div class="col-l">
									<p style="text-indent:2em;">
										本考试系统是一款基于JAVA与MYSQL开发的网络考试系统。它可以稳定、顺畅的运行在Windows与Linux平台上。您可以通过它快捷方便的创建试题和题库，发布试卷，组织考试，系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。
									</p>
									<p style="text-indent:2em;">
				...
				<div class="row">
					...
					<div class="field-category-footer">
						...
						<div class="field-category-footer-sub">
							...
							<span class="field-student-num">899</span>
