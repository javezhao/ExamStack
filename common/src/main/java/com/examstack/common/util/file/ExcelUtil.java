...
public class ExcelUtil {
	...
	public static List<Map<String,String>> ExcelToList(String filePath) throws Exception{
		...
		System.out.println("enter  ExcelUtil ExcelToList  zwj  filePath....  " + filePath);

		
		FileInputStream fi = null;
		try {
			System.out.println("enter  try ..ExcelUtil ExcelToList  zwj  filetype...." + filetype);

			fi = new FileInputStream(filePath);
			System.out.println("after try  ExcelUtil ExcelToList  zwj  filetype...." + filetype);
