...
public class QuestionServiceImpl implements QuestionService {
	...
	public void addQuestion(Question question) {
		// TODO Auto-generated method stub
		try {
			System.out.println("QuestionServiceImpl addQuestion    zwj ....");
	...
	public void uploadQuestions(String filePath, String username, int fieldId) {
		...
		System.out.println("QuestionServiceImpl  uploadQuestions enter zwj....");
		...
		int index = 2;
		try {
			System.out.println("QuestionServiceImpl  uploadQuestions try zwj....");

			List<Map<String, String>> questionMapList = ExcelUtil.ExcelToList(filePath);
			
			System.out.println("QuestionServiceImpl  uploadQuestions before enter for zwj....");

			for (Map<String, String> map : questionMapList) {

				System.out.println("QuestionServiceImpl  uploadQuestions  enter for zwj....");
