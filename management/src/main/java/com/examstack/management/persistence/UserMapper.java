...
public interface UserMapper {
	 ...
	 * 根据单位名，获取单位的 ID
	 */
	public int getdepIDbydepname(String department);
	 ...
	 * @return
	 */
	public List<Department> getDepartListByUserId(@Param("userId") int userId, @Param("page") Page<Department> page);
	 ...
	 * 
	 */
	public List<User> getUserListByDepartmentIdAndParams(@Param("departmentId") int departmentId, @Param("authority") String authority,
			@Param("searchStr") String searchStr, @Param("page") Page<User> page);
	
	/**
	 * 根据userName（2级管理员账号）  和关键字来查询用户
	 *  zwj add
	 * @param userName
	 *           
	 * @param searchStr
	 ...
	 * @return
	 */
	public List<User> getUserListByParams(@Param("depID") int depID, @Param("authority") String authority,
			@Param("searchStr") String searchStr, @Param("page") Page<User> page);
	
	public int getUserDepartID(@Param("userID") int userID);
