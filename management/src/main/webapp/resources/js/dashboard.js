...
var dashboard = {
	...
	drawStudentApprovedTable : function drawStudentApprovedTable(ehlist) {
		...
		for(var i = 0 ; i < ehlist.length ; i++){
			...
			html += "</td>";
			html += "<td>";
			html += "<span><button class=\"disapproved-btn btn btn-success\" data-id=\"" + ehlist[i].histId + "\">审核</button> <button class=\"disapproved-btn btn btn-warning\" data-id=\"" + ehlist[i].histId + "\">拒绝</button></span>"
			html += "</td>";
			html += "</tr>";
