...
<html>
  <head>
	...
	<body>
        ...
        <!-- 上传结果信息提示 -->
	<span id="message" style="position:absolute;top:80px;left:15px;text-align:center;background-color:#0000007d;color:#fff;width:100px;display:none;"></span>
	<!-- 上传图片预览 -->
        <img src="" alt="" id="o_photo_img" width="100" height="100" >
        <!-- 上传按钮 -->
	<input type="file" name="o_photo_file" id="o_photo" onchange="uploader(this.files)" style="display: none">
        <!-- 上传成功后图片路径储存位置，用于form提交 -->
	<input type="hidden" name="o_photo">
        <!-- 选择图片按钮 -->
	<label for="o_photo" class="webuploader-pick" id="o_photo_label" >选择图片</label>
        <!-- 上传按钮 -->
	<div class="webuploader-pick" style="display:none;" id="uploader_btn" onclick="uploader_query()">上传图片</div>
</div>
	...
	-->
		...
		<script type="text/javascript" src="resources/js/question-upload-img2.js"></script>
