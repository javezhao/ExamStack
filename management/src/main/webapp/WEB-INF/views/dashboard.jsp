						...
						<c:choose>
							<c:when test="${not empty sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}">
								<div id="login-info-user">
									...
									<a href="user-detail/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.department}" id="system-info-depart" target="_blank">${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.department}</a>
									<span>|</span>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="copy">
							<p>
								 Copyright © <a href="http://www." target="_blank">在线考试系统</a> - <a href="." target="_blank">主页</a> | <a href="http://www" target="_blank">关于我们</a> | <a href="http://www" target="_blank">FAQ</a> | <a href="http://www" target="_blank">联系我们</a>
							</p>
						</div>
					</div>
				</div>
