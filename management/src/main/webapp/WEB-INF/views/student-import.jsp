...
<html>
	...
	<body>
				...
				<div class="row">
					...
					<div class="col-xs-10" id="right-content">
						<div class="page-header">
							<h1><i class="fa fa-cloud-upload"></i> 导入学员 </h1>
						</div>
						<div class="page-content" style="padding-top:20px;">
							<form id="from-student-import" action="secure/student-import">
			
							<div class="form-line template-download">
								<span class="form-label">下载模板：</span>
								<a href="resources/template/user.xlsx" style="color:rgb(22,22,22);text-decoration: underline;">点击下载</a>
							</div>
							...
							<div class="form-line">
								<input value="提交" type="submit" class="df-submit btn btn-info" id="submit" >
							</div>
						</form>
						</div>
					</div>
		...
		<script type="text/javascript" src="resources/js/student-import.js"></script>
		<script type="text/javascript" src="resources/js/all.js"></script>
