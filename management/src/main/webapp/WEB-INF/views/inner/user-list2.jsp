...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="resources/js/user-list-inner2.js"></script>
		...
		<script type="text/javascript">
			$(function() {
				...
				btnSearch.click(function() {
					...
					var url = util.getCurrentRole() + "/user/inner/user-list2/" + groupId  + "-" + authority + "?searchStr=" + searchStr;
